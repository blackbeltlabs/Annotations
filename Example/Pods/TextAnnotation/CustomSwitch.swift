...
public class CustomSwitch: NSControl {
  ...
  public var inactiveIcon = NSImage(named: "T_shadow_selected") {
    didSet {
      reloadLayer()
    }
  }
  public var activeIcon = NSImage(named: "T_shadow_unselected") {
    didSet {
      reloadLayer()
    }
  }
  public var secondIcon: NSImage? = NSImage(named: "T_outline") {
    didSet {
      reloadLayer()
    }
  }
